...
function C2 = admmLasso_mat_func_CSI_SSC_CPU(Y,affine,alpha,ks,thr,maxIter,lambda,alphass,Md,Nd)
...
if (~affine)
    ...
    while ( (err1(i) > thr1 || err3(i) > thr1) && i < maxIter )
        ...
        time=toc;
        i = i + 1;
        fprintf('Iteracion :%d   err1: %d err3: %d  time: %d \n',i,err1(i),err3(i),time);
    end
